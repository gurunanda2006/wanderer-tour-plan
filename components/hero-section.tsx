  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 text-balance drop-shadow-2xl font-mono">
          {t("hero.title")}{" "}
          <span className="text-white drop-shadow-[0_0_20px_rgba(59,130,246,0.8)]">{t("hero.telangana")}</span>
        </h1>
        <p className="text-xl md:text-2xl mb-8 text-gray-200 text-pretty drop-shadow-lg opacity-50">{t("hero.subtitle")}</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div className="bg-black/20 rounded-lg p-3 transition-all duration-300 hover:bg-black/40 hover:scale-105 opacity-50">
